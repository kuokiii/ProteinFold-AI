        ...
        <div className="grid gap-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              At ProteinFold AI, we are dedicated to revolutionizing the field of protein structure prediction and drug discovery. 
              Our mission is to accelerate scientific research and pharmaceutical development by providing cutting-edge AI-driven tools for protein analysis.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8">
            ...
            <p className="text-gray-300 mb-4">
              We leverage state-of-the-art deep learning models and molecular modeling techniques to predict protein structures with high accuracy. 
