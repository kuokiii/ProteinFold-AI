      ...
      >
        {publications.map((pub, index) => (
          ...
          >
            ...
            <p className="text-gray-400 mb-2 font-body">{pub.journal}, {pub.year}</p>
            <a href={`https://doi.org/${pub.doi}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline font-body">
              DOI: {pub.doi}
            </a>
          </motion.div>
        ))}
