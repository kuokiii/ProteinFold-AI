          ...
          {sortedProteins.map((protein, index) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p><span className="text-gray-400">Formula:</span> {protein.formula}</p>
                <p><span className="text-gray-400">Weight:</span> {protein.molecularWeight} Da</p>
                <p><span className="text-gray-400">Function:</span> {protein.function}</p>
                <p><span className="text-gray-400">Disease:</span> {protein.disease}</p>
              </div>
            </motion.div>
          ))}
        </div>
