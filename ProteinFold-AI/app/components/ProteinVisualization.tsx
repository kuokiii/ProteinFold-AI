...
const aminoAcidColors: { [key: string]: string } = {
  'A': '#FF6B6B', 'R': '#4ECDC4', 'N': '#45B7D1', 'D': '#F9C74F', 'C': '#FF9FF3',
  'E': '#43AA8B', 'Q': '#F8961E', 'G': '#90BE6D', 'H': '#577590', 'I': '#277DA1',
  'L': '#9C89B8', 'K': '#F94144', 'M': '#F3722C', 'F': '#43AA8B', 'P': '#577590',
  'S': '#90BE6D', 'T': '#F9C74F', 'W': '#F8961E', 'Y': '#F94144', 'V': '#4ECDC4',
  'B': '#FF9FF3', 'J': '#277DA1', 'O': '#F3722C', 'U': '#9C89B8', 'X': '#577590',
  'Z': '#43AA8B'
};
...
export default function ProteinVisualization({ sequence }: { sequence: string }) {
  ...
  useEffect(() => {
    ...
    const validPositions = aminoAcids.map(aa => aa.position).filter(pos => pos && pos.x !== undefined && pos.y !== undefined && pos.z !== undefined);
