        ...
        <div className="grid grid-cols-1 gap-8 items-center mb-16 relative">
          <div>
            ...
            <p className="mb-8 text-xl text-gray-300 leading-relaxed font-body text-center max-w-3xl mx-auto">
              ProteinFold AI leverages cutting-edge <span className="text-blue-400 font-semibold">deep learning</span> models and <span className="text-purple-400 font-semibold">molecular modeling</span> techniques to accelerate drug discovery and enhance therapeutic design.
            </p>
