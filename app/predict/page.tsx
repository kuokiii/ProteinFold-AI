    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        >
          ...
          >
            Enter a <span className="text-blue-400 font-semibold">protein sequence</span> below to predict its structure
            and analyze its <span className="text-purple-400 font-semibold">properties</span> using our advanced{" "}
            <span className="text-pink-400 font-semibold">AI models</span>.
          </motion.p>
